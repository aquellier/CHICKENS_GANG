...
ChickensGang.create!(gang_name: "Gang1", breed: "Silkie", capacity: 4, price: 10, owner_id: 1, address: "Rua de Moeda 6, Lisbon", price_cents: 100)
ChickensGang.create!(gang_name: "Gang2", breed: "Plymouth Rock", capacity: 4, price: 10, owner_id: 2,address: "Rua do Conde de Redondo 79, Lisbon", price_cents: 100)
ChickensGang.create!(gang_name: "Gang3", breed: "Orpington", capacity: 4, price: 10, owner_id: 2,address: "Cascais", price_cents: 100)
ChickensGang.create!(gang_name: "Gang4", breed: "Legorne", capacity: 4, price: 10, owner_id: 2,address: "Carnaxide", price_cents: 100)
ChickensGang.create!(gang_name: "Gang5", breed: "Brahma", capacity: 4, price: 10, owner_id: 2,address: "Viseu", price_cents: 100)
